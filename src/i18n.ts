...
const dict: Record<string, [string, string]> = {
  ...
  'settings.bridge.toObsidian.desc': ['开启后，DSH 生成的库内可阅读文件（如产物路径）点击即在 Obsidian 内打开阅读；仅作用于 Vault 内的可读文件', 'When enabled, readable files generated by DSH inside your vault (e.g. artifact paths) open in Obsidian with one click; only applies to readable in-vault files'],
