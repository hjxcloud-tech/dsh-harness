 ...
 * `@x1a0f3n9/dsh-client-connection` 等社区 scope，与官方**共用 0.1.5-rc.x 号段**：官方 0.1.5-rc.3 发布于 2026-09-22，
 * 第三方同名 rc.3/4/5 发布于 09-18～09-20）都可能被当成本体：版本读错 → 适配判定错 → 弹「不适配」窗误导用户，更新/降级建议也跟着错。
 *
